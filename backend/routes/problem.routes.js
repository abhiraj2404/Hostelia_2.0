...
// List problems (role-based): student -> own problems, warden -> problems of their hostel, collegeAdmin -> all problems
router.get('/', listProblems);

// Add a comment to a problem (all roles allowed)
router.post('/:id/comments', addProblemComment);

// Update problem status (warden/collegeAdmin)
router.patch('/:id/status', authorizeRoles('warden', 'collegeAdmin'), updateProblemStatus);
