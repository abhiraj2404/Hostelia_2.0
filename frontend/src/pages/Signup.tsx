            ...
            <CardContent>
              <form onSubmit={step1Form.handleSubmit(onStep1Submit)} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  />
                  {step1Form.formState.errors.rollNo && <p className="text-xs text-red-600">{step1Form.formState.errors.rollNo.message}</p>}
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="roomNo" type="text" placeholder="e.g., 101" disabled={isFormLoading} {...step1Form.register("roomNo")} />
