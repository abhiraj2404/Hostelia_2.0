  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <MetricCard
        label="Fees"
        value={
          (typeof metrics.fees === "object" &&
          metrics.fees !== null &&
          "pending" in metrics.fees &&
          typeof metrics.fees.pending === "number"
            ? metrics.fees.pending
            : 0) || 0
        }
      ...
      <MetricCard
        ...
        description={`Avg: ${
          metrics.messFeedback?.avgRating.toFixed(1) || 0
        }⭐`}
