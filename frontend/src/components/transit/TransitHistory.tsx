    ...
    <Card className="relative border overflow-hidden bg-card shadow-lg hover:shadow-xl transition-shadow flex flex-col h-full">
      <CardHeader className="bg-muted/50 text-foreground pb-3 px-5 py-4">
        ...
        <div className="mt-3 grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <Select
            value={statusFilter}
            onValueChange={(v: "ALL" | "ENTRY" | "EXIT") => {
              setStatusFilter(v);
              setCurrentPage(1);
            }}
          >
            ...
            <div className="text-center py-20 px-4 space-y-4">
              ...
              <div className="space-y-2 max-w-md mx-auto">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Create your first entry or exit record above to start tracking
                  your transit movements
                </p>
              </div>
            </div>
                    ...
                    <Table>
                      <TableHeader className="sticky top-0 bg-gray-100 dark:bg-gray-900 z-10 shadow-sm">
                        <TableRow className="border-b-2 border-gray-300 dark:border-gray-700">
                          <TableHead className="w-14 px-3 py-2 font-semibold text-gray-900 dark:text-white text-sm text-center">
                            #
                          </TableHead>
                          <TableHead className="px-3 py-2 font-semibold text-gray-900 dark:text-white text-sm min-w-[100px]">
                            Date
                          </TableHead>
                          <TableHead className="px-3 py-2 font-semibold text-gray-900 dark:text-white text-sm min-w-20">
                            Time
                          </TableHead>
                          <TableHead className="px-4 py-2 font-semibold text-gray-900 dark:text-white text-sm min-w-[70px]">
                            Type
                          </TableHead>
                          <TableHead className="px-3 py-2 font-semibold text-gray-900 dark:text-white text-sm min-w-[200px]">
                            Purpose
                          </TableHead>
                        </TableRow>
                      </TableHeader>
              ...
              <div className="lg:hidden p-2 space-y-3 max-h-[600px] overflow-y-auto">
                {paginatedEntries.map((entry, index) => {
                  ...
                  return (
                    <Card
                      key={entry._id}
                      className="border border-gray-200 dark:border-gray-800 overflow-hidden hover:shadow-lg transition-all duration-200"
                    >
                      <CardContent className="p-3 space-y-2">
                        ...
                        <div className="pt-1 border-t border-gray-200 dark:border-gray-800">
                          ...
                          <p className="text-xs font-mono font-semibold text-gray-900 dark:text-gray-100 mt-1">
                            {formatTime(entry.time)}
                          </p>
                        </div>
